...
import { deleteProfile, getProfile, updateRecoveryEmail, updateUserName, updateUserProfilePic } from "../controllers/userController";
...
router.put("/update-recovery-email", authenticateMiddleware, updateRecoveryEmail);
